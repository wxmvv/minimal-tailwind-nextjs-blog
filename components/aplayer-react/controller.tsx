...
import IconLrc from './assets/lrc.svg'
import IconOrderList from './assets/order-list.svg'
import IconOrderRandom from './assets/order-random.svg'
import IconLoopAll from './assets/loop-all.svg'
import IconLoopOne from './assets/loop-one.svg'
import IconLoopNone from './assets/loop-none.svg'
  ...
  return (
    <div className="aplayer-controller">
      <ProgressBar
        ...
        onSeek={(progress) =>
          audioDurationSeconds !== undefined && onSeek?.(progress * audioDurationSeconds)
        }
      />
      <div className="aplayer-time">
        ...
        />
        <button className="aplayer-icon aplayer-icon-order" onClick={handleOrderButtonClick}>
          {{ list: <IconOrderList />, random: <IconOrderRandom /> }[order]}
        </button>
        <button className="aplayer-icon aplayer-icon-loop" onClick={handleLoopButtonClick}>
          {
            {
              all: <IconLoopAll />,
              one: <IconLoopOne />,
        ...
        <button className="aplayer-icon aplayer-icon-menu" onClick={() => onToggleMenu?.()}>
          <IconMenu />
        </button>
        <button
          type="button"
